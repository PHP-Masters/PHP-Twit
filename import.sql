...
--
-- Host: localhost:8889
-- Generation Time: May 17, 2016 at 12:06 AM
...
(49, '@Julian', '', '#hello #hey', '', 3, 0, '2016-05-07', 0, 0),
(52, '@Julian', 'Hello #autohashtags - this works well', '#autohashtags ', '', 0, 0, '2016-05-07', 0, 0),
(55, '@Julian', 'It''s my very own tweet #tweets @asd @test', '#tweets ', '@asd @test ', 2, 1, '2016-05-07', 0, 0),
(56, '@julian', 'The new error #error messages look so good @julian', '#error ', '@julian ', 4, 3, '2016-05-07', 0, 0),
(58, '@test', '"Hello"', '', '', 9, 2, '2016-05-08', 0, 0),
(59, '@test', 'Hello #test', '#test ', '', 24, 13, '2016-05-09', 0, 0),
(60, '@test', 'Testing the time #testing', '#testing ', '', 15, 3, '2016-05-11', 9, 0),
(61, '@test', 'This shows time and date', '', '', 8, 16, '2016-05-12', 38, 0),
(62, '@test', 'Testing the time', '', '', 2, 8, '2016-05-12', 26, 0),
(63, '@test', 'Also testing the time function', '', '', 0, 0, '2016-05-16', 1463400104, 0),
(64, '@test', 'Testing the time #testing', '#testing ', '', 4, 0, '2016-05-16', 1463424636, 0);
...
(1, 'test', '68b1b2f150f62deff233bd033c3952f620bc524b678af9dc41979ba299432e4e', '203a60d44b5cb80', 'test@gmail.com', 'This is my new bio.'),
